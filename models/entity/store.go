...
type RetailStore struct {
	...
	ReceiptTemplate                     *EmbeddedTemplate `json:"receiptTemplate,omitempty"`                     // Метаданные шаблона печати кассовых чеков
	...
	QrAcquire          *Meta          `json:"qrAcquire"`                    // Метаданные банка-эквайера по операциям по QR-коду
