...
type Assortment struct {
	...
	MinPrice            *general.MinPrice   `json:"minPrice,omitempty"`
	SalePrices          []general.SalePrice `json:"salePrices,omitempty"`
	BuyPrice            *general.BuyPrice   `json:"buyPrice,omitempty"`
	Barcodes            []general.Barcode   `json:"barcodes,omitempty"`
	...
	Files               []general.File      `json:"files,omitempty"`
	Stock               float64             `json:"stock"`
	Reserve             float64             `json:"reserve"`
	InTransit           float64             `json:"inTransit"`
	Quantity            float64             `json:"quantity"`
	ProductFolder       *ProductFolder      `json:"productFolder,omitempty"`
	Uom                 *general.Uom        `json:"uom,omitempty"`
	Weighed             bool                `json:"weighed,omitempty"`
	Attributes          []general.Attribute `json:"attributes,omitempty"`
	Components          *Components         `json:"components"`
}

type Images struct {
	Meta    *general.Meta   `json:"meta"`           // Метаданные
	Context *general.Meta   `json:"context"`        // Метаданные о сотруднике выполнившем запрос
	Rows    []general.Image `json:"rows,omitempty"` // Массив структур изображений
}
