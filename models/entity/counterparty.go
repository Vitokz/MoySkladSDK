...
type Counterparty struct {
	...
	Created            time.Time           `json:"created,omitempty"`            // Момент создания
	...
	State              *general.State      `json:"state,omitempty"`              // Метаданные статуса контрагента
	...
	PriceType          *general.PriceType  `json:"priceType,omitempty"`          // Тип цены Контрагента
}
...
type Note struct {
	...
	Id                string        `json:"id,omitempty"`                // Id контактного
	AccountId         string        `json:"accountId,omitempty"`         // Id учетной записи
	Created           time.Time     `json:"created,omitempty"`           // Время создания
	Description       string        `json:"description,omitempty"`       // Описание контактного лица
	Agent             *Counterparty `json:"agent,omitempty"`             // Метаданные контрагента
	Author            *Employee     `json:"author,omitempty"`            // Метаданные сотрудника-создателя события
	AuthorApplication *general.Meta `json:"authorApplication,omitempty"` // Метаданные приложения
}
